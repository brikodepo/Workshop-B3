  ...
  return (
    <>
      <div>
        ...
        <div className="mx-auto px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16 block p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
